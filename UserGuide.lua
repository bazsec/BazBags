            ...
            children = {
                {
                    ...
                    blocks = {
                        ...
                        { type = "paragraph", text = "Toggle |cffffd700Separate Each Bag|r off in |cffffd700Layout|r to fall back to the chunky two-section layout (Bags + Reagents merged - Blizzard's combined-bag style)." },
